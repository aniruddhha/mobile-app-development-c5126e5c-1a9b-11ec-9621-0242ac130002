 ...
 * Use the [RecProfileFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RecProfileFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RecProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RecProfileFragment().apply {
